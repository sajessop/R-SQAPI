...
export <- function(api,
  ...
  # Initial request
  response <- make_request(url, verb, token, write_disk, filename)
...
# Can also structure as request then pipe into parse
  r1 <- request("GET", api, "api/media_collection", my_filters1) %>% parse()
