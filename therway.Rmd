...
request <- function(verb,
  ...
  make_request <- function(verb, url, token, body = NULL) {
    ...
    Authorization = paste("Bearer", api$auth), 
...
```{r}
# post_me <- httr::content(r, "text", encoding = "UTF-8")
post_me <- list(
  id = 1,
  data = list(),
  name = "Example Annotation",
  description = "example description",
  media_collection_id = 123,
  label_scheme_id = 456,
  user_id = 789,
  created_at = "2025-04-04T12:00:00Z",
  parent_id = NULL,
  is_exemplar = FALSE,
  is_full_bio_score = TRUE,
  is_real_science = FALSE,
  is_qaqc = FALSE,
  is_final = FALSE,
  type = "base"
)

posting <- request(verb = "POST", api = api, endpoint = "api/annotation_set", body = post_me)
...
# Can also structure as request then pipe into parse (should work for all examples)
